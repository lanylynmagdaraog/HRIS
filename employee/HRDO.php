...
<head>
  ...
  <!-- <title >FELLOWSHIP BAPTIST COLLEGE  </title> -->
...
<div class="wrapper">
  ...
  <section class="invoice">
    ...
    <div class="row">
      <div class="col-xs-12" style="text-align:center;"> 
			<p style="font-size:14px">FELLOWSHIP BAPTIST COLLEGE</p> 
			<p style="font-size:12px">Kabankalan City, Negros Occidental</p>
  ...
  <td><label>Place of Birth :</label></td>
    ...
    <tr>
      ...
      <td colspan="2"><?php echo $emp->TINNO ?></td>

      <td ><label>SSS No.</label></td>
      <td colspan="2"><?php echo $emp->SSSNO ?></td>
       
    </tr> 
    <tr>
    <td><label>Philheath No.</label></td>
      <td colspan="2" > <?php echo $emp->PHNO ?></td>
     <td  ><label>Pag-ibig No.</label></td>
      <td colspan="2"> <?php echo $emp->PAGIBIGNO ?></td>
    </tr>  
    <tr>
    <td><label>GSIS No.(if any)</label></td>
      <td colspan="2" > <?php echo $emp->GSISNO ?></td>
     <td  ><label>PERAA No.</label></td>
      <td colspan="2"><?php echo $emp->PERAANO ?></td>
    </tr>
    <tr>
  ...
  <table class="table table-striped  table-hover table-bordered" style="font-size:12px" cellspacing="0">
   <thead>
   <tr>
        <td colspan="6" style="background-color:#000;color:#fff;font-size:15px">CIVIL SERVICE ELIGIBILITY</td> 
      </tr>
    <tr style="text-align:center"> 
    <td width="250px" rowspan="2">Career Service/ RA 1080 (Board/BAR) Under Special Law/ CES/CSEE</td>
  ...
  <tbody>
    ...
    foreach ($cur as $result) {  
      ...
      echo '<td>'. $result->DATERELEASED.'</td>';  
...
<?php  
    ...
    @$otherres =  $mydb->fetch_array($result); 
?>
...
<table class="table   table-bordered" style="font-size:12px" cellspacing="0">
   <thead style="text-align:center">
    <tr >  
       <td rowspan="2">Special Skills/ Hobbies</td>
       <td colspan="2" width="200px" >Non-Academic Distinctions/ Recognition/ Awards</td>
    </tr>
  </thead> 
  <tbody>
   <tr>
     <td><textarea class="form-control" style="border: 0px;" rows="9" name=""><?php echo isset($otherres['SKILLS']) ? $otherres['SKILLS'] : ''; ?></textarea></td>
     <td><textarea class="form-control" style="border: 0px;" rows="9" name=""><?php echo  isset($otherres['NDRA']) ?  $otherres['NDRA'] : ''; ?></textarea></td>
   </tr> 
  </tbody>
...
<br/><br/><br/><br/><br/><br/><br/><br/>
 <table class="table   table-bordered" style="font-size:12px;text-align: center;" cellspacing="0">
   <tr>
     <td colspan="2">
      I declare under oath that this Employee Personal Data Sheet has been accomplished by me, and is a true, correct and complete statement pursuant to the provisions of pertinent laws, rules and regulations of the Republic of the Philippines.
      <br/>
      I also authorize the head/authorized representative of Fellowship Baptist College to verify/validate the contents stated herein. I trust that this information shall remain confidential.
   ...
   <tr>
     <td width="200px">Community Tax Certificate No.</td>
