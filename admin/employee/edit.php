  ...
  if ($emp->SEX == 'Male') {
   ...
   switch ($emp->WORKSTATS) {
     ...
     case 'Contractual':
       ...
       break;
     case 'Service of Contract Worker':
       # code...
         $workstatus='
         <select class="form-control input-sm" name="WORKSTATS" id="WORKSTATS">
                                      <option value="none" >Select</option>
                                      ...
                                      <option SELECTED value="Contract of Service Worker">Contract of Service Worker</option> 
                                  </select> ';
     ...
     default:
       ...
       <select class="form-control input-sm" name="WORKSTATS" id="WORKSTATS">
                                      ...
                                      <option value="Regular">Regular</option>
                                      <option value="Contractual">Contractual</option>
                                      <option value="Contract of Service Worker">Contract of Service Worker</option> 
                                  </select> ';
        break;
...
<section id="feature" class="transparent-bg">
  ...
  <div class="col-md-8 col-md-offset-4">
    <div class="d-flex gap-2">
      <button class="btn btn-mod btn-sm" name="save" type="submit">
        <span class="fa fa-save fw-fa"></span> Save
      </button>
      <button class="btn btn-mod btn-sm" name="next" type="submit" formaction="controller.php?action=next">
        <span class="fa fa-save fw-fa"></span> Next
      </button>
    </div>
  </div>
</div>                         
