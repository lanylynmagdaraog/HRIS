            ...
            <div class="features"> 
                <div class="row">
                  <div class="col-xs-12" style="padding:0px;" align="center">
                    <label>FELLOWSHIP BAPTIST COLLEGE</label> 
                     <div style="font-size: 12px">Kabankalan City, Negros Occidental</div>
                  ...
                  <table class="tbl">
                    ...
                    <tr>
                      ...
                      <td colspan="5" class="underline"  style="font-size:12px;text-align:center;">DR. DAVID V. GARGANTIEL,RN,MAN, PhD.</td> 
                    </tr>
                     <tr>
                ...
                <div class="row">
                  ...
                  <table class="tbl">
                    ...
                    <tr>
                      ...
                      <td colspan="5" class="underline"  style="font-size:12px">DR. DAVID V. GARGANTIEL,RN,MAN, PhD.</td> 
                    </tr>
                     <tr>
                      <td colspan="3" align="center">Employee</td> 
                      <td colspan="3" align="center">Department Head</td> 
