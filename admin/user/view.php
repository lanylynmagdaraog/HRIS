                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="panel">            
                              ...
                              <img title="profile image" class="img-hover"    src="<?php echo web_root. 'employee/'.  $res->USERPHOTO; ?>">
                                ...
                                <li class="list-group-item text-right"><span class="pull-left"><strong>Name</strong></span> <?php echo $emp->FNAME .' '.$emp->LNAME; ?> </li>
                               <li class="list-group-item text-right"><span class="pull-left"><strong>Department</strong></span> <?php echo isset($dept->DEPARTMENT)  ? $dept->DEPARTMENT : 'NONE'; ?> </li> 
                          ...
                          <div class="row"> 
                              <div class="col-lg-12">
                                  ...
                                  <ul id="myTab" class="nav nav-tabs nav-justified">
                                      ...
                                      <li class=""><a href="#service-two" data-toggle="tab">Education</a>
                                      </li>
