 ...
 <form class="form-horizontal span6 " action="controller.php?action=editbasicinfo" method="POST"> 
  ...
  <td><label>Place of Birth :</label></td>
    ...
    <tr>
      ...
      <td colspan="2">
         <input type="text" name="TINNO" class="input form-control" value="<?php echo $emp->TINNO ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </td>

      <td ><label>SSS No.</label></td>
      <td colspan="2">  
          <input type="text" name="SSSNO" class="input form-control" value="<?php echo $emp->SSSNO ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">      
      </td>
    ...
    <td><label>Philheath No.</label></td>
      <td colspan="2" >
       <input type="text" name="PHNO" class="input form-control" value="<?php echo $emp->PHNO ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">      
            </td>
     <td  ><label>Pag-ibig No.</label></td>
      <td colspan="2">
       <input type="text" name="PAGIBIGNO" class="input form-control" value="<?php echo $emp->PAGIBIGNO ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">      
            </td>
    </tr>  
    <tr>
    <td><label>GSIS No.(if any)</label></td>
      <td colspan="2" >
        <input type="text" name="GSISNO" class="input form-control" value="<?php echo $emp->GSISNO ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">      
            </td>
     <td  ><label>PERAA No.</label></td>
      <td colspan="2">
       <input type="text" name="PERAANO" class="input form-control" value="<?php echo $emp->PERAANO ?>"  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">      
            </td>
    </tr>
    <tr>
