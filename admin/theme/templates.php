...
<body class="homepage" >
    ...
    <header id="header">
        ...
        <nav class="navbar navbar-mod navbar-fixed-top" role="banner" style="background-color:#1434A4;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a  class="navbar-brand" href="<?php echo web_root; ?>admin/"><h3 style="color:#fff;">PSA NSAMAR HUMAN RESOURCE INFORMATION SYSTEM (NSamarHRIS)</h3></a>
                </div>
                    ...
                    <?php //} ?> 
                            ...
                            <ul class="dropdown-menu"   style="background-color:#6495ED;" >
                               <?php 
                                  //if ($_SESSION['UROLE']=='Administrator'|| $_SESSION['UROLE']=='MainAdministrator' ) {
                                        # code...
                                 ?>
                                <li class="<?php echo (currentpage() == 'department') ? "active" : false;?>"><a href="<?php echo web_root; ?>admin/department/index.php">Departments</a></li>
						...
						<li class="dropdown"> 
                            ...
                            <ul class="dropdown-menu"   style="background-color:#6495ED;" >
                                ...
                                <li class="<?php echo (isset($_GET['view']) && $_GET['view'] == 'listofemployees') ? "active" : false;?>"><a href="<?php echo web_root; ?>admin/report/index.php?view=listofemployees">List of Employee</a></li>
...
<div class="modal fade" id="BACKTOZERO" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      </div>
      <div class="modal-body">
      <div class="alert alert-danger">Are you Sure you Want to <strong>return all leave credits into 0</strong>?</div>
      </div>
      <div class="modal-footer">
          <button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove"></i> Close</button>
          <a href="<?php echo web_root; ?>admin/credits/controller.php?action=backtozero" class="btn btn-info"><i class="icon-off"></i> Ok</a>
      </div>
    </div> 
    </div>
</div> 
    ...
    <footer id="footer" class="midnight-blue" style="background-color:#1434A4; float:bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-7">
                    &copy; 2025 <a target="_blank" href="<?php echo web_root; ?>" title="Free Twitter Bootstrap WordPress Themes and HTML templates">PSA NSAMAR HUMAN RESOURCE INFORMATION SYSTEM (NSamarHRIS)</a>. All Rights Reserved.
                </div>
