              ...
              <div class="row-fluid">
                <div class="span12"></div>
                    <div class="row-fluid">
                      ...
                      <img class="index_logo" src="img/bg/psa_l.png">
                      </div>  
                      <div class="span12" style="text-align:center">
                        <div class="motto" > 
                        <h1><p>PSA Northern Samar Human Resource Information System </p><p>(NSamarHRIS)</p></h1>                          
                        </div>                      
                      </div>              
                    </div>                    
              </div>  
...
<script>
 ...
 <center>
  ...
  <p style="color:#fff">
    ...
    <br>
    <br>
                    &copy; 2025 <a style="color:#fff" target="_blank" href="<?php echo web_root; ?>" title="PSA NSAMAR HUMAN RESOURCE INFORMATION SYSTEM">PSA NSAMAR HUMAN RESOURCE INFORMATION SYSTEM</a>. All Rights Reserved.
       </p>          
    </footer><!--/#footer-->
</center>
