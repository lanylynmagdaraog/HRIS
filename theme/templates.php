...
<body class="homepage" >
    ...
    <header id="header">
        ...
        <nav class="navbar navbar-mod navbar-fixed-top" role="banner" style="background-color:#1705a3;">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- <a class="navbar-brand" href="<?php echo web_root; ?>admin/"><img style="width:60px" src="<?php echo web_root; ?>admin/img/bg/fbc_logo.png" alt="logo"></a> -->
                </div>
                
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav mod-menu" style="font-size:13px;"  >
               
                        <li hover="ff9933" class="<?php echo (isset($_GET['page']) && $_GET['page'] == 1) ? "active" : false;?>">  <a href="<?php echo web_root; ?>index.php?page=1">Home</a></li>
                        <li  class="<?php echo (isset($_GET['page']) && $_GET['page'] == 2) ? "active" : false;?>"> <a href="<?php echo web_root; ?>index.php?page=2">Mission and Vision</a></li>
                     <li  class="<?php echo (isset($_GET['page']) && $_GET['page'] == 3) ? "active" : false;?>"> <a href="<?php echo web_root; ?>index.php?page=3">Core Values</a></li> 
                     <li  class="<?php echo (isset($_GET['page']) && $_GET['page'] == 4) ? "active" : false;?>"> <a href="<?php echo web_root; ?>index.php?page=4">Contact Us</a></li> 
                    <?php 
  ...
  <!-- <section id="bottoms" style="border-bottom:5px solid #ff9933 ">
    ...
    <footer id="footer" class="midnight-blue" style="border-top:5px solid #ff9933 ;background-color:#1705a3; float:bottom; height:80px;">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2025 <a target="_blank" href="<?php echo web_root; ?>" title="Free Twitter Bootstrap WordPress Themes and HTML templates">NSamarHRIS</a>. All Rights Reserved.
                </div>
